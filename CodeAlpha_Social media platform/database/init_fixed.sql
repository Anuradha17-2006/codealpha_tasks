-- ConnectSphere Database Schema - FIXED
CREATE DATABASE IF NOT EXISTS connectsphere;
USE connectsphere;

-- Users Table (FIXED - removed defaults from JSON/TEXT columns)
...
INSERT INTO users (
    ...
    is_admin, is_verified, email_verified, user_level
) VALUES (
    'admin-001',
    'Admin',
    'User',
...
SELECT TABLE_NAME FROM information_schema.TABLES WHERE TABLE_SCHEMA = 'connectsphere';
